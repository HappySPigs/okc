...
[`AGENTS.md`](../../../okc-core/AGENTS.md): current specifications, stable algorithms, then
accepted ADRs. Current implementation and release evidence are tracked in
[`docs/CURRENT_STATE.md`](../../../okc-core/docs/CURRENT_STATE.md) and
[`docs/TRACEABILITY.md`](../../../okc-core/docs/TRACEABILITY.md).
