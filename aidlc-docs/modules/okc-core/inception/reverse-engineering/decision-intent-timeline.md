...
> [`docs/TRACEABILITY.md`](../../../../../okc-core/docs/TRACEABILITY.md) and [`docs/CURRENT_STATE.md`](../../../../../okc-core/docs/CURRENT_STATE.md),
...
- **Founding rule — documentation-first**: *"세웠던 플랜과 앞선 gpt 세션들 그리고 뇌과학 알고리즘과 로직을
  ...
  → this is the origin of the docs-first mandate in [`AGENTS.md`](../../../../../okc-core/AGENTS.md), `docs/algorithms/`,
...
> These rows were cross-checked against [`docs/TRACEABILITY.md`](../../../../../okc-core/docs/TRACEABILITY.md) and
