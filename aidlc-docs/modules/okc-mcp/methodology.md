...
> **Official workflow installation (2026-09-06):** Following the user's later installation request, the Codex distribution of version 2.7.1 was installed. Follow the [setup guide](../../../okc-mcp/docs/aidlc-setup.md) for current usage, provenance, and diagnostics. The abbreviated method below is preserved as a historical, unapproved proposal. Installation does not create approval or completion for earlier stages.
