...
Status: implementation authorized by the user's 2026-09-09 request, under the existing autopilot authorization. This module owns MCP changes; umbrella coordination remains in the [root integration workspace](../../../../README.md).
