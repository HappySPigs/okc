...
| E1-2 | 앱 셸 · RBAC 내비 · 계정 메뉴 | App Shell 레이아웃(React Router layout route) | **admin 전용** | E1 | FR-AUTH-3,4,2 | App | — |
...
### E1-2 — 앱 셸 · RBAC 내비 · 계정 메뉴 (App Shell 레이아웃 — React Router layout route)
